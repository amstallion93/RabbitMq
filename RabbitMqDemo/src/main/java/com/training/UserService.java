...
import com.training.config.ApplicationConfigReader;
import com.training.dto.UserDetails;
import com.training.util.ApplicationConstant;

//The Boot controller for adding a message to the queue
//This method uses the hardcoded values for exchange,routing key etc.
...
public class UserService {
	...
	public ResponseEntity<?> sendMessage(@RequestBody UserDetails user) {
		...
		/* Sending to Message Queue ,Please not the parameters passed here for exchange
		 * routing key etc.*/
		try {
